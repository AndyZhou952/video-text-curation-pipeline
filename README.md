...
- [x] **Dataset Management**
  ...
  - [x] Filtering
- [x] **Scene Detection and Video Splitting**
  - [x] Adaptive Detector Support
  - [x] Content Detector Support
  - [x] Scene Cut Support
- [x] **Video De-duplication**
  - [x] Hashing
- [x] **Scoring**
  - [x] Aesthetic Scoring
  - [x] Matching Scoring
...
- [x] **Multi-NPU Parallel Processing**
...
This code is extracted from `tools/t2v_curation` in [mindspore-lab/mindone](https://github.com/mindspore-lab/mindone) (Apache-2.0) and was originally contributed by the author via PRs [#826](https://github.com/mindspore-lab/mindone/pull/826) and [#914](https://github.com/mindspore-lab/mindone/pull/914).
