# Copied from https://github.com/idealo/imagededup/blob/master/imagededup/handlers/search/bktree.py
...
class BKTree:
    ...
    def _insert_in_tree(self, k: str, current_node: str) -> int:
        ...
        condition_insert_current_node_child = (not self.dict_all[current_node].children) or (
